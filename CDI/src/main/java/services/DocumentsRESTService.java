...
public class DocumentsRESTService extends AbstractFacade<Documents> {

    @PersistenceContext(unitName = "persistance-unit")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Documents entity) {
        super.edit(entity);
    }
